...
function loadView(href, title){
	...
	* Особенно важно, когда на странице совершаются действия, для которых нужен валидный токен */
	...
	$("#main-view").load("https://russiabase.ru/wm/v0.3.0/manager/" + href, function(response, status, xhr){
		if(status == "error"){
			$("#main-view").load("https://russiabase.ru/wm/v0.3.0/manager/views/404.html");
